                    ...
                    <div className="col-lg" id="show-col-lg-12">
                        ...
                        {showAlertSuccess? (
                            <div class="d-flex justify-content-center">
                                <div class="alert success-box fade show" role="alert">
                        ...
                        {showAlertDelete? (
                            <div class="d-flex justify-content-center">
                                <div class="alert delete-box fade show" role="alert">
                                    ...
                                    return(
                                        <div class="col mt-5 p-0 d-flex justify-content-center align-item-center" key={item.id}>
                                            <div class="card-list">
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <button type="button" class="btn border border-2 border-danger rounded-2 me-3 delete-btn" data-bs-toggle="modal" data-bs-target="#deleteCarModal" onClick={() => {
                                ...
                                <div class="modal-content" style={{maxWidth: '387px'}}>
                                    <div class="popup text-center">
                                        ...
                                        <div class="d-flex justify-content-center mt-4">
                                            ...
                                            <button type="button" class="btn btn-popup-yes mx-2" onClick={() => {
                                                handleDeleteAlert()
